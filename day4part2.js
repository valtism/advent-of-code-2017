...
function run(passphrasesArray) {
    const validPassphrases = passphrasesArray.reduce((numValid, passphraseString) => {
        const passphrases = passphraseString.split(' ');
        if (!containsAmagram(passphrases)) {
            return numValid + 1;
        } else {
            return numValid;
        }
...
function containsAmagram(wordArray) {
